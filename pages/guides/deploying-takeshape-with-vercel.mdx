...
export const meta = {
  ...
  lastEdited: '2020-07-10T15:04:13.000Z',
  rank: 7
}
...
These will be added during the import of the project to Vercel so keep a note of them until completed. You will find information on where to find these values below:
